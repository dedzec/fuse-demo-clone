...
function FloatingActionButtonDoc() {
  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        appears in front of all screen content, typically as a circular shape
        with an icon in its center. FABs come in two types: regular, and
        extended.
      </Typography>
      <Typography className="mb-16" component="div">
