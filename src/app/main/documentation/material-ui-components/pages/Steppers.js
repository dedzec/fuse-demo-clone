  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/archive/guidelines/components/steppers.html">
          Steppers
        </a>{' '}
        display progress through a sequence of logical and numbered steps. They
        may also be used for navigation. Steppers may display a transient
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ...
          <a href="https://material.io/">Material Design guidelines</a>, but
          Material-UI will continue to support them.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-16" component="div">
        ...
        index (zero-based) as the <code>activeStep</code> property.{' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>optional</code> property on the second <code>Step</code>{' '}
        component. Note that it&#39;s up to you to manage when an optional step
        is skipped. Once you&#39;ve determined this for a particular step you
        must set <code>{`completed={false}`}</code> to signify that even though
        the active step index has gone beyond the optional step, it&#39;s not
        actually complete.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        This is essentially a back/next button positioned correctly. You must
        implement the textual description yourself, however, an example is
      ...
      <Typography className="mb-16" component="div">
        This demo is very similar to the previous, the difference is the usage
        of
