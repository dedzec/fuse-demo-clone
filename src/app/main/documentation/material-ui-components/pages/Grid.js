  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        column width. Material Design margins and columns follow an{' '}
        <strong>8px</strong> square baseline grid. The spacing property is an
        integer between 0 and 10 inclusive. By default, the spacing between two
        grid items follows a linear function:{' '}
      ...
      <Typography className="mb-16" component="div">
        The column widths apply at all breakpoints (i.e. <code>xs</code> and
        up).
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        Some columns have multiple widths defined, causing the layout to change
      ...
      <Typography className="mb-16" component="div">
        The following demo doesn&#39;t follow the Material Design specification,
      ...
      <Typography className="mb-16" component="div">
        The <code>container</code> and <code>item</code> properties are two
      ...
      <Typography className="mb-16" component="div">
        There is one limitation with the negative margin we use to implement the
        spacing between items. A horizontal scroll will appear if a negative
        margin goes beyond the <code>{`<body>`}</code>. There are 3 available
        workarounds:
      </Typography>
      <ol>
        <li>
        ...
        <li>
          Applying padding to the parent with at least half the spacing value
...
`}
      ...
      <Typography className="mb-16" component="div">
        Though the <code>Grid</code> component has a <code>direction</code>{' '}
        property that allows values of <code>row</code>,{' '}
        <code>row-reverse</code>, <code>column</code>, and{' '}
        <code>column-reverse</code>, there are some features that are not
        supported within <code>column</code> and <code>column-reverse</code>{' '}
        containers. The properties which define the number of grids the
        component will use for a given breakpoint (<code>xs</code>,{' '}
        <code>sm</code>, <code>md</code>, <code>lg</code>, and <code>xl</code>)
        are focused on controlling width and do <strong>not</strong> have
        similar effects on height within <code>column</code> and{' '}
        <code>column-reverse</code> containers. If used within{' '}
        <code>column</code> or <code>column-reverse</code> containers, these
        properties may have undesirable effects on the width of the{' '}
        <code>Grid</code> elements.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        CSS Grid Layout
      </Typography>
