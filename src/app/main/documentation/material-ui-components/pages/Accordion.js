  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        is a lightweight container that may either stand alone or be connected
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ...
          Material-UI will continue to support them. It was formerly known as
          the &quot;expansion panel&quot;.
        </Typography>
      </blockquote>
      ...
      <Typography className="mb-16" component="div">
        In order to put an action such as a <code>Checkbox</code> or a button
        inside of the <code>AccordionSummary</code>, you need to stop the
        propagation of the focus and click events to prevent the accordion from
        expanding/collapsing when using the action. You should also provide an{' '}
        <code>aria-label</code> for the action, otherwise the label of the
        nested action will be included in the label of the parent button that
        controls the accordion expansion.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-16" component="div">
        Multiple columns can be used to structure the content, and a helper text
        may be added to the accordion to assist the user.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
