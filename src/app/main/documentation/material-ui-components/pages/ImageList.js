  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        to add an overlay to each <code>ImageListItem</code>. The overlay can
        accommodate a <code>title</code>, <code>subtitle</code> and secondary
        action - in this example an <code>IconButton</code>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        This example demonstrates a horizontal scrollable single-line image list
        of images. Horizontally scrolling image lists are discouraged because
        the scrolling interferes with typical reading patterns, affecting
        comprehension. One notable exception is a horizontally-scrolling,
      ...
      <Typography className="mb-16" component="div">
        This example demonstrates &quot;featured&quot; items, using the{' '}
        <code>rows</code> and <code>cols</code> props to adjust the size of the
        item, and the <code>gap</code> prop to adjust the spacing. The items
        have a customized titlebar, positioned at the top, and with a custom
        gradient <code>titleBackground</code>. The secondary action{' '}
