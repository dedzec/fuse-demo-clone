  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/dividers.html">
          Dividers
        </a>{' '}
      ...
      <Typography className="mb-16" component="div">
        ...
        rendering this DOM element by using the <code>divider</code> property on
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>orientation</code> prop. Note the use of the <code>flexItem</code>{' '}
