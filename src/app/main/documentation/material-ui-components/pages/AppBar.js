  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        provides content and actions related to the current screen. It’s used
...
`}
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>options.disableHysteresis</code> (<em>Boolean</em>{' '}
              [optional]): Defaults to <code>false</code>. Disable the
              hysteresis. Ignore the scroll direction when determining the{' '}
