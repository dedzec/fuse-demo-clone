  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        (or &quot;sidebars&quot;) provide access to destinations and app
        functionality, such as switching accounts. They can either be
      ...
      <Typography className="mb-16" component="div">
        ...
        can use the <code>disableBackdropTransition</code> property to help.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
...
`}
      ...
      <Typography className="mb-16" component="div">
        The <code>Hidden</code> responsive helper component allows showing
        different types of drawer depending on the screen width. A{' '}
        <code>temporary</code> drawer is shown for small screens while a{' '}
