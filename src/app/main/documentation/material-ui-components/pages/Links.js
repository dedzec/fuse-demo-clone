  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/api/typography/">Typography</a> component. You can leverage
        its properties.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        However, the Link component has different default properties than the
      ...
      <Typography className="mb-16" component="div">
        ...
        an HTTP round-trip to the server. The <code>Link</code> component
        provides a property to handle this use case: <code>component</code>.
      </Typography>
      <Typography className="mb-16" component="div">
        Here is an{' '}
        <a href="/guides/composition/#link">
