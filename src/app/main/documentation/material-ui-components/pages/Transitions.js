  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        Material-UI provides a number of transitions that can be used to
        introduce some basic
        <a href="https://material.io/design/motion/">motion</a>
        to your applications components.
      </Typography>
      <Typography className="mb-16" component="div">
        To better support server rendering Material-UI provides a{' '}
        <code>style</code> property to the children of some transition
        components (Fade, Grow, Zoom, Slide). The <code>style</code> property
        must be applied to the DOM for the animation to work as expected.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>collapsedSize</code> property can be used to set the minimum
        height when not expanded.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        Expand outwards from the center of the child element, while also fading
      ...
      <Typography className="mb-16" component="div">
        The Transition component&#39;s <code>mountOnEnter</code> property
        prevents the child component from being mounted until <code>in</code> is{' '}
        <code>true</code>. This prevents the relatively positioned component
        from scrolling into view from it&#39;s off-screen position. Similarly
        the <code>unmountOnExit</code> property removes the component from the
        DOM after it has been transition off screen.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        The components accept a <code>TransitionComponent</code> prop to
        customize the default transitions. You can use any of the above
