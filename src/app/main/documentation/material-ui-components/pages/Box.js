  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        are exposed in <code>@material-ui/system</code>. It&#39;s created using
        the{' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        component defines its own color. CSS inheritance doesn&#39;t help. To
        workaround the problem, you have two options:
      </Typography>
      <ol>
        <li>
          Use{' '}
      ...
      <Typography className="mb-16" component="div">
        The Box component has a <code>clone</code> property to enable the usage
        of the clone element method of React.
      </Typography>
...
`}
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ⚠️ The CSS specificity relies on the import order. If you want the
          guarantee that the wrapped component&#39;s style will be overridden,
...
`}
      ...
      <table>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td align="left">
              If <code>true</code>, the box will recycle its children DOM
              element. It&#39;s using <code>React.cloneElement</code>{' '}
              internally.
            </td>
          </tr>
          <tr>
      ...
      <Typography className="mb-16" component="div">
        ...
        <a href="/system/basics/#all-inclusive">the style functions</a> or
