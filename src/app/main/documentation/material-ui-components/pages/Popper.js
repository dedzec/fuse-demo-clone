    ...
    <>
      ...
      <ul>
        <li>
          ...
          <a href="https://github.com/FezVrasta/popper.js">Popper.js</a>) for
          perfect positioning.
        </li>
        <li>
        ...
        <li>
          ...
          <a href="https://bundlephobia.com/result?p=popper.js">7 kB</a> from
          Popper.js).
        </li>
        <li>
          The children is{' '}
      ...
      <Typography className="mb-16" component="div">
        The <code>anchorEl</code> property can be a reference to a fake DOM
        element. You just need to create an object shaped like the{' '}
