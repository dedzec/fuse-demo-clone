  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>usePagination()</code> hook. It accepts almost the same options as
        the Pagination component minus all the props related to the rendering of
        JSX. The Pagination component uses this hook internally.
      </Typography>
