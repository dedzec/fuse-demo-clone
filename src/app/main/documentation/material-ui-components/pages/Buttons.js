  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/buttons.html">Buttons</a>{' '}
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        page. The <code>ButtonBase</code> component provides a property to
        handle this use case: <code>component</code>. However for certain focus
        polyfills <code>ButtonBase</code> requires the DOM node of the provided
        component. This is achieved by attaching a ref to the component and
        expecting that the component forwards this ref to the underlying DOM
        node. Given that many of the interactive components rely on{' '}
        <code>ButtonBase</code>, you should be able to take advantage of it
        everywhere.
      </Typography>
      <Typography className="mb-16" component="div">
        Here is an{' '}
        <a href="/guides/composition/#button">
      ...
      <ol>
        <li>
          <Typography className="mb-16" component="div">
            <strong>CSS only</strong>. You can remove the pointer events style
            on the disabled state of the <code>{`<button>`}</code> element:
          </Typography>
...
`}
          ...
          <ul>
            <li>
              You should add <code>pointer-events: none;</code> back when you
              need to display{' '}
...
`}
          ...
          <Typography className="mb-16" component="div">
            This has the advantage of supporting any element, for instance, a
