  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/sliders.html">Sliders</a>{' '}
      ...
      <ul>
        <li>
          📦 <a href="/size-snapshot">22 kB gzipped</a> (but only +8 kB when
          used together with other Material-UI components).
        </li>
      </ul>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>value</code> on a different scale. For instance, in the following
        demo, the value <em>x</em> represents the power of <em>10^x</em>.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
