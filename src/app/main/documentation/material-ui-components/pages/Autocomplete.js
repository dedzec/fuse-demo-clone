...
function AutocompleteDoc() {
  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        Each of the following examples demonstrate one feature of the
      ...
      <blockquote>
        <Typography className="mb-16" component="div">
          ⚠️ These two state are isolated, they should be controlled
          independently.
        </Typography>
      </blockquote>
      <Typography className="mb-16" component="div">
      ...
      <ul>
        ...
        <li>
          ...
          <kbd>Home</kbd> and <kbd>End</kbd> keys.
        </li>
        <li>
      ...
      <Typography className="mb-16" component="div">
        For advanced customization use cases, we expose a headless{' '}
        <code>useAutocomplete()</code> hook. It accepts almost the same options
        as the Autocomplete component minus all the props related to the
        rendering of JSX. The Autocomplete component uses this hook internally.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        Head to the{' '}
        <a href="#customized-autocomplete">Customized Autocomplete</a> section
        for a customization example with the <code>Autocomplete</code> component
        instead of the hook.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
...
`}
      ...
      <ol>
        <li>
          ...
          <ul>
            <li>
              <code>config.ignoreAccents</code> (<em>Boolean</em> [optional]):
              Defaults to <code>true</code>. Remove diacritics.
            </li>
            <li>
              <code>config.ignoreCase</code> (<em>Boolean</em> [optional]):
              Defaults to <code>true</code>. Lowercase everything.
            </li>
            <li>
              <code>config.limit</code> (<em>Number</em> [optional]): Default to
              null. Limit the number of suggested options to be shown. For
              example, if <code>config.limit</code> is <code>100</code>, only
              the first <code>100</code> matching options are shown. It can be
              useful if a lot of options match and virtualization wasn&#39;t set
              up.
            </li>
            <li>
            ...
            <li>
              <code>config.stringify</code> (<em>Func</em> [optional]): Controls
              how an option is converted into a string so that it can be matched
              against the input text fragment.
            </li>
            <li>
              <code>config.trim</code> (<em>Boolean</em> [optional]): Defaults
              to <code>false</code>. Remove trailing spaces.
            </li>
          </ul>
        </li>
      </ol>
...
`}
      ...
      <Typography className="mb-16" component="div">
        By default, the component disable the <strong>autocomplete</strong>{' '}
        feature (remembering what the user has typed for a given field in a
        previous session) with the <code>autoComplete="off"</code> attribute.
      </Typography>
      <Typography className="mb-16" component="div">
        However, in addition to remembering past entered values, the browser
        might also propose <strong>autofill</strong> suggestions (saved login,
        address, or payment details). In the event you want the avoid autofill,
