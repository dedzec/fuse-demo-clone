  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        All elements are visible unless{' '}
        <strong>they are explicitly hidden</strong>. To ease integration with
        Material-UI&#39;s{' '}
        <a href="/customization/breakpoints/">responsive breakpoints</a>, this
        component can be used to hide any content, or you can use it in
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>only='sm'</code> or <code>{`only={['md', 'xl']}`}</code>. Ranges
        and individual breakpoints can be used simultaneously to achieve very
        customized behavior. The ranges are inclusive of the specified
        breakpoints.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        By default, the <code>js</code> implementation is used, responsively
        hiding content based on using the{' '}
        <a href="/customization/breakpoints/#withwidth">
          <code>withWidth()</code>
        </a>{' '}
        higher-order component that watches screen size. This has the benefit of
        not rendering any content at all unless the breakpoint is met.
      </Typography>
      <Typography className="text-24 mt-32 mb-8" component="h3">
        css
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        <em>children</em> will be hidden <em>at or above</em> the breakpoint.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        ...
        <em>children</em> will be hidden <em>at or below</em> the breakpoint.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        ...
        <em>children</em> will be hidden <em>at</em> the specified
        breakpoint(s).
      </Typography>
      <Typography className="mb-16" component="div">
      ...
      <Typography className="mb-16" component="div">
        It is quite common to alter <code>Grid</code> at different responsive
        breakpoints, and in many cases, you want to hide some of those elements.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
