  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        with the <code>showZero</code> property.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        You can use the <code>max</code> property to cap the value of the badge
        content.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
      ...
      <Typography className="mb-16" component="div">
        The <code>dot</code> property changes a badge into a small dot. This can
      ...
      <Typography className="mb-16" component="div">
        You can use the <code>overlap</code> property to place the badge
        relative to the corner of the wrapped element.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
