  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        When activated,{' '}
        <a href="https://material.io/design/components/tooltips.html">
          Tooltips
        </a>{' '}
        display a text label identifying an element, such as a description of
        its function.
      </Typography>
      ...
      <Typography className="mb-16" component="div">
        ...
        don’t have directional arrows; instead, they rely on motion emanating
      ...
      <Typography className="mb-16" component="div">
        ...
        spreads its properties to the underlying DOM element.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        the properties <code>enterDelay</code> and <code>leaveDelay</code>, as
        shown in the Controlled Tooltips demo above.
      </Typography>
      <Typography className="mb-16" component="div">
        ...
        with the <code>disableTouchListener</code> property.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
