  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        loaded by Material-UI. The developer is responsible for loading all
        fonts used in their application. Roboto Font has a few easy ways to get
...
`}
      ...
      <Typography className="mb-16" component="div">
        ...
        doesn&#39;t eager load all the font variations (100/300/400/500/700/900,
        italic/regular, SVG/woff). Fontsource can be configured to load specific
        subsets, weights and styles. Inlining all the font files can
        significantly increase the size of your bundle. Material-UI default
        typography configuration only relies on 300, 400, 500, and 700 font
        weights.
      </Typography>
      <Typography className="text-32 mt-32 mb-8" component="h2">
        Component
      ...
      <Typography className="mb-16" component="div">
        The Typography component uses the <code>variantMapping</code> property
        to associate a UI variant with a semantic element. It’s important to
        realize that the style of a typography is independent from the semantic
        underlying element.
      </Typography>
      <ul>
        <li>
...
`}
      ...
      <ul>
        <li>
          ...
          <a href="/customization/globals/#default-props">
