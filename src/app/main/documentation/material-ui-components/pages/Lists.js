  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        <a href="https://material.io/design/components/lists.html">Lists</a> are
        a continuous group of text or images. They are composed of items
        containing primary and supplemental actions, which are represented by
        icons and text.
      </Typography>
...
`}
      ...
      <Typography className="mb-16" component="div">
        You should change the list item alignment when displaying 3 lines or
        more, set the <code>alignItems="flex-start"</code> property.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
          className="my-24"
      ...
      <Typography className="mb-16" component="div">
        ...
        pushed off screen by the next subheader.
      </Typography>
      <Typography className="mb-16" component="div">
        This feature relies on CSS sticky positioning. Unfortunately it&#39;s{' '}
        <a href="https://caniuse.com/#search=sticky">not implemented</a> by all
        the supported browsers. It defaults to <code>disableSticky</code> when
        not supported.
      </Typography>
      <Typography className="mb-16" component="div">
        <FuseExample
