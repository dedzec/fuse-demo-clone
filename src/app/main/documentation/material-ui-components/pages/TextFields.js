  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="div">
        ...
        <code>helperText</code> which is used to give context about a field’s
      ...
      <Typography className="mb-16" component="div">
        <code>margin</code> prop can be used to alter the vertical spacing of
        inputs. Using <code>none</code> (default) will not apply margins to the{' '}
        <code>FormControl</code>, whereas <code>dense</code> and{' '}
        <code>normal</code> will.
        <code>dense</code> and <code>normal</code> alter other styles to meet
        the specification.
      </Typography>
      <Typography className="mb-16" component="div">
