  ...
  return (
    <>
      ...
      <Typography className="mb-16" component="p">
        ...
        package manager to install and manage 3rd party components and
        libraries.
      </Typography>
      ...
      <div className="my-24 px-12 py-8 border-1 border-red rounded-16">
        ...
        <Typography className="" component="div">
          ...
          <br />
          if not recover the contents and add{' '}
          <code>yarnPath: ".yarn/releases/yarn-berry.js"</code> at the top.
        </Typography>
      </div>
